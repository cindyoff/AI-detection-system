...
print("Significant difference" if char_pval < 0.05 else "No significant difference")

print(f"\nT-test number of words — p-value : {word_pval:.4e}")
print("Significative difference" if word_pval < 0.05 else "No significant difference")
